...
const Upload: NextPage = () => {
  return (
    <div className="px-4 py-16">
      ...
      <div className="my-5">
        ...
        <div className="relative flex items-center rounded-md shadow-sm">
          ...
          <div className="pointer-events-none absolute right-0 flex items-center pr-3">
            <span className="text-gary-500">USD</span>
          </div>
        </div>
      </div>
      <div>
      ...
      <button
        className="focus-outline-none mt-5 w-full rounded-md border border-transparent bg-orange-500 py-2 px-4 text-sm font-medium text-white 
          shadow-sm hover:bg-orange-600 focus:ring-2 focus:ring-orange-500 focus:ring-offset-2"
      >
        Upload product
      </button>
    </div>
