    ...
    <div className="space-y-8 py-16 px-4">
      {[1, 2, 3, 4, 5, 6].map((_, i) => (
        <div key={i} className="flex flex-col items-start">
          ...
          <div className="itmes-center mt-5 flex w-full justify-between text-xs text-gray-500">
            <span>니꼬</span>
            <span>18시간 전</span>
          </div>
      ...
      <button className="marker: fixed bottom-24 right-5 cursor-pointer rounded-full bg-orange-400 p-4 text-white shadow-xl transition-colors hover:bg-orange-500">
        <svg
          className="h-6 w-6"
          fill="none"
          stroke="currentColor"
